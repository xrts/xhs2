(function(window, undefined){
	...
	ImagesZoom.prototype = {
		...
		init: function(param){
			...
			var imgList   = [
				[
					'http://s0.ifengimg.com/2017/10/20/6-1-1_5211396d.jpg',
					'http://s0.ifengimg.com/2017/10/20/6-1-2_c3323ef3.jpg',
					'http://s0.ifengimg.com/2017/10/20/6-2-1_d594eb98.jpg',
					'http://s0.ifengimg.com/2017/10/20/6-2-2_262ad70c.jpg',
					'http://s0.ifengimg.com/2017/10/20/6-2-3_1abac7e4.jpg',
					'http://s0.ifengimg.com/2017/10/20/6-3_8d87b2b3.jpg',
					'http://s0.ifengimg.com/2017/10/20/6-4-1_0ded03fc.jpg',
					'http://s0.ifengimg.com/2017/10/20/6-4-2_6f237133.jpg'
				],
				[
					'http://s0.ifengimg.com/2017/10/20/8-1-1_f786b12c.jpg'
				]],
			...
			zoomClose.addEventListener("click", function(){
				...
				var bigClass =$('.'+'big-glass'+param.pageNum)[0];
				bigClass.addEventListener("click", function(){
					var i = $('.'+'list'+param.pageNum+' .swiper-slide-active').index();
					
					// console.log(i);
					imgSrc = imgList[param.pageNum][i];
					zoomMask.style.cssText = "display:block";
					$('.imgzoom_pack .sk-circle').fadeIn();
					zoomImg.src = imgSrc;
					...
					zoomImg.onload = function(){
						...
						$(this).fadeIn();
						$(this).css('marginTop', '-'+(zoomImg.offsetHeight/2)+"px");
						// 禁止页面滚动
